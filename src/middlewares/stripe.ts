...
declare global {
  var stripeRateLimit: Map<string, { count: number; resetTime: number }> | undefined
}
...
export function stripeErrorHandler(error: any, req: Request, res: Response, next: NextFunction) {
...
export function stripeRateLimit(req: Request, res: Response, next: NextFunction) {
...
export function validateStripeCustomer(req: Request, res: Response, next: NextFunction) {
...
export function validateStripePrice(req: Request, res: Response, next: NextFunction) {
...
export function logStripeOperation(req: Request, res: Response, next: NextFunction) {
  const userEmail = (req as any).user?.email
