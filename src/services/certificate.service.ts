...
export class CertificateService {
   ...
   */
  static async getCertificate(studentEmail: string, courseId: string): Promise<string | null> {
    try {
   ...
   */
  static async isCourseCompleted(studentEmail: string, courseId: string): Promise<boolean> {
    try {
      const { data, error } = await supabaseAdmin
        .from('enrollments')
        .select('completed_at')
   ...
   */
  static async markCourseCompleted(studentEmail: string, courseId: string): Promise<void> {
    try {
