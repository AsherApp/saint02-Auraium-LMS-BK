...
router.post('/:code/complete', asyncHandler(async (req, res) => {
    ...
    first_name, last_name, date_of_birth, phone_number, address, city, state, country, postal_code, emergency_contact_name, emergency_contact_phone, emergency_contact_relationship, academic_level, major, minor, graduation_year, gpa, academic_interests, career_goals, bio, timezone, preferred_language, accessibility_needs, dietary_restrictions } = req.body;
    // Validate required fields
