    ...
    try {
        ...
        for (const course of courses) {
          ...
          `)
                ...
                const totalLessons = courseStructure.modules?.reduce((acc, module) => acc + (module.lessons?.length || 0), 0) || 0;
                const totalAssignments = courseStructure.assignments?.length || 0;
                const totalQuizzes = courseStructure.modules?.reduce((acc, module) => acc + (module.quizzes?.length || 0), 0) || 0;
